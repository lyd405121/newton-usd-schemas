...
from simulate_rod import RodSimulation, _resolve_usd_path
...
def snapshot(usd_path: Path, out_dir: Path, viewer) -> Path | None:
    ...
    try:
        sim = RodSimulation(usd_path=str(usd_path), viewer=viewer, num_steps=1,
                            substeps=10, iterations=5, fps=60)
...
def main():
    ...
    parser.add_argument("--asset-dir", type=Path, default=DEFAULT_ASSET_DIR,
                        help="Directory containing .usda asset files")
